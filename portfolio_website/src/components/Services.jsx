...
const servicesData = [
  ...
  },
  {
    ...
    list: ['Motion graphics & VFX', 'Kinetic typography', 'Logo animations', 'Title sequences', 'Explainer animations']
  },
  {
    icon: '🎬',
...
const Services = () => {
  return (
    <section id="services">
      <div className="section-eyebrow reveal">What I Do</div>
      <h2 className="section-title reveal reveal-delay-1">Premium creative<br />services.</h2>
